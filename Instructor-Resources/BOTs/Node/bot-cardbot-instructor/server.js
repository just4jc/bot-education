...
It's part of the bot-education labs.  This is the instructor version of the bot
used in the Attachments and Cards Lab.
    ...
    function (session, results) {
        ...
        .text("You said yes")
            .attachments([{
                ...
                contentUrl: "https://www.projectmurphy.net/Images/thinking_morphi.png"
            }]);
        ...
        var msg = new builder.Message(session)
            ...
            .attachments([
                new builder.HeroCard(session)
                    .title("Hero Card")
                    .subtitle("")
                    .text("Why choose just one?  Well, you don't have to.  Take `rpy2`, `rPython`, `feather` project, and more.")
                    .images([
                        builder.CardImage.create(session, 
                        "http://www.orison.biz/blogs/ch3ckmat3/wp-content/uploads/2015/06/r-vs-python-header.png")
                    ])
