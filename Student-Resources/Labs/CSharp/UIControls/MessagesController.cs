    ...
    public class MessagesController : ApiController
    {
        ...
        public class SimpleDialog : IDialog
        {
            ...
            public async Task GiveTask(IDialogContext context, IAwaitable<IMessageActivity> result)
            {
                ...
                if (activity.Text.ToLower().Contains("income"))
                {
                    await context.PostAsync($"Enter Income Amount");
                    //context.Wait(GiveTask);
                }
                else if (activity.Text.ToLower().Contains("expense"))
                {
                    await context.PostAsync($"Enter Expense Amount");
                    //context.Wait(GiveTask);
                }
                ...
                else
                {
                    ...
                    var PromptOptions = new string[] { "Income", "Expenses", "Goodbye" };
                    PromptDialog.Choice(context, TestConfirm, PromptOptions, $"I'm a PnL Bot. What would you like to do?");
